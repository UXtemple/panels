...
const Content = (props, context) =>
  <Vertical
    style={{
      ...
      marginTop: 25,
      opacity: props.on ? 1 : 0.5,
    }}
    _ref={props._ref}
  >
    <Text text={text} />
    {context.scrollTo
      ? <button onClick={() => context.scrollTo(300)}>scroll to 300</button>
      : null}
  </Vertical>
        ...
        >
          ...
          >
            ...
            <Horizontal
              ...
              styleHover={{ backgroundColor: 'lightgreen', color: 'white' }}
            >
              {'/a'}
            </Horizontal>
...
export const types = {
  ...
  Lightblue: props =>
    <Vertical
      style={{ backgroundColor: 'lightblue', padding: 20, width: props.width }}
    >
  ...
  Fuchsia: props =>
    <Vertical
      style={{ backgroundColor: 'fuchsia', padding: 20, width: props.width }}
    >
...
export const panels = {
  '/': {
    type: 'Lightgreen',
    maxWidth: 720,
    styleBackground: { backgroundColor: '#f2f2f2' },
    title: 'main',
  },
