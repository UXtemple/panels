...
},{"mini-unique-id":"mini-unique-id","panels-ui":"panels-ui","react":"react","style-to-css":"style-to-css","waiting":"waiting"}],"launchpad.panels.dev":[function(require,module,exports){
'use strict';
...
var normaliseUri = _interopDefault(require('panels-normalise-uri'));
var React = require('react');
var React__default = _interopDefault(React);
...
var Content = function (_Component) {
  ...
  function Content() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.isActive = function (path) {
      var _this$props$panels = _this.props.panels;
      var route = _this$props$panels.route;
      var router = _this$props$panels.router;

      return normaliseUri('' + route.context + path) === router.uri;
    }, _temp), possibleConstructorReturn(_this, _ret);
  }

  Content.prototype.getChildContext = function getChildContext() {
    return {
...
var LAUNCHPAD_HEIGHT = 50;
var Launchpad = function Launchpad(_ref) {
  var router = _ref.panels.router;
  ...
  return React__default.createElement(
    usepagesBlocks.Horizontal,
    { style: { backgroundColor: '#323232', height: LAUNCHPAD_HEIGHT } },
    React__default.createElement(
      usepagesBlocks.Horizontal,
      {
    ...
    React__default.createElement(usepagesBlocks.Horizontal, { style: { flex: 1 } }),
    React__default.createElement(
      usepagesBlocks.Horizontal,
      {
        style: _extends({}, styleNext, {
