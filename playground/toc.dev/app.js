...
},{"mini-unique-id":"mini-unique-id","panels-ui":"panels-ui","react":"react","style-to-css":"style-to-css","waiting":"waiting"}],"toc.dev":[function(require,module,exports){
'use strict';
...
var getTeleportTo = function getTeleportTo(_ref) {
  var path = _ref.path;
  var route = _ref.route;
  var routeIndex = _ref.routeIndex;
  var router = _ref.router;

  var prevRouteContext = router.routes.items[routeIndex - 1];
  var prevRoute = router.routes.byContext[prevRouteContext];

  var currentPathToRemainInContext = route.context.replace(prevRouteContext, '');
  var dotsToGoBack = currentPathToRemainInContext.split('/').map(function (s, i) {
    return i > 0 ? '../' : '';
  }).join('');
...
var Toc = function (_Component) {
  ...
  Toc.prototype.getChildContext = function getChildContext() {
    return {
  ...
  Toc.prototype.render = function render() {
    ...
    var _props$panels = _props.panels;
    var route = _props$panels.route;
    var routeIndex = _props$panels.routeIndex;
    var router = _props$panels.router;
      ...
      list.map(function (_ref2) {
        ...
        return React__default.createElement(
          usepagesBlocks.Horizontal,
          {
            ...
            teleportTo: getTeleportTo({ path: path, routeIndex: routeIndex, route: route, router: router })
          },
          title
        );
      })
